...
steps:
  qc_1:
    run: https://raw.githubusercontent.com/suecharo/dashi/master/tests/resources/cwl/fastqc.cwl
    in:
      nthreads: nthreads
      fastq: fastq_1
    out:
  ...
  qc_2:
    ...
    out:
      ...
      - stderr
  trimming:
    run: https://raw.githubusercontent.com/suecharo/dashi/master/tests/resources/cwl/trimmomatic_pe.cwl
    in:
      nthreads: nthreads
      fastq_1: fastq_1
      fastq_2: fastq_2
